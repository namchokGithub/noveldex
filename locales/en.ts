const en = {
  ...
  "entities.searchPlaceholder": "Search entity name…",
  ...
  "entities.deleteEyebrow": "Confirm deletion",
  "entities.deleteTitle": "Delete {name}?",
  "entities.deleteDescription": "This entity will be deleted.",
  "entities.relatedRecords": "Related records",
  "entities.loadRelatedRecords": "Show related records",
  "entities.loadingRelatedRecords": "Loading related records…",
  "entities.relatedRecordsError": "Could not load related records.",
  "entities.notes": "Notes",
  "entities.addNote": "Add note",
  "entities.noNotes": "No notes yet.",
  "entities.noteNumber": "Note {number}",
  "entities.noteRequired": "Enter a note before saving.",
  "entities.deleteNoteTitle": "Delete note?",
  "entities.deleteNoteBody": "This note will be deleted.",
