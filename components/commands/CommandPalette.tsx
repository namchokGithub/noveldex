...
export default function CommandPalette() {
  ...
  const navigationCommands = useMemo<Command[]>(() => chapterPage ? [] : [
    ...(novelId ? [{ id: 'overview', label: t('command.novelOverview'), hint: t('command.novelOverviewHint'), href: `/novels/${novelId}`, keywords: 'novel overview home' }, { id: 'characters', label: t('command.characters'), hint: t('command.charactersHint'), href: `/novels/${novelId}/characters`, keywords: 'characters cast people ตัวละคร' }, { id: 'entities', label: t('command.entities'), hint: t('command.entitiesHint'), href: `/novels/${novelId}/entities`, keywords: 'entities locations skills organizations items concepts เอนทิตี' }, { id: 'timeline', label: t('command.timeline'), hint: t('command.timelineHint'), href: `/novels/${novelId}/timeline`, keywords: 'timeline events story เหตุการณ์' }] : []),
